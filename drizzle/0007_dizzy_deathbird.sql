...
ALTER TABLE `user` ALTER COLUMN "supabase_id" TO "supabase_id" text NOT NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX `user_supabase_id_unique` ON `user` (`supabase_id`);--> statement-breakpoint
