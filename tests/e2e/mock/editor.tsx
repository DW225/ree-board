          ...
          <nav style={{ display: "flex", gap: 16, marginBottom: 24 }}>
            <Sheet>
              ...
              <SheetContent side="left">
                ...
                <SheetDescription>Test navigation</SheetDescription>
                <a href="#board">Board</a>
              </SheetContent>
            </Sheet>
            <Select value={role} onValueChange={setRole}>
              <SelectTrigger aria-label="Role" style={{ width: 140 }}>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
            ...
            <TooltipProvider delayDuration={0}>
              <Tooltip>
                ...
                <TooltipContent>Board help</TooltipContent>
              </Tooltip>
            </TooltipProvider>
            {!deleted && (
              <AlertDialog>
...
if (params.get("review") === "expiration") {
  fixture = (
    <>
      ...
      <MagicLinkManager boardId="mock" viewOnly={false} />
      <Toaster />
    </>
  );
  ...
  fixture = (
    <>
      <ImportMembersComponent currentBoardId="mock" />
